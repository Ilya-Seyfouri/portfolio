...
import { faHome, faEnvelope, faFolderOpen, faBars, faClose } from '@fortawesome/free-solid-svg-icons'
...
const Sidebar = () => {
    ...
    return(
        <div className = 'nav-bar'> 
            ...
            <ul className='git'>
                <li>
                    <a target = "_blank" rel = "noreferrer" href = "https://linkedin.com/in/ilya-seyfouri-3824422a0">
